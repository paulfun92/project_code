...
from simplelearn.training import (limit_param_norms,
                                  ...
                                  StopsOnStagnation,
                                  EpochLogger)
from RMSprop_extensions import RMSpropNesterovSgdParameterUpdater, RMSpropSgdParameterUpdater
...
def main():
    ...
    def add_updaters(parameter,
        ...
        parameter_updaters.append(RMSpropSgdParameterUpdater(parameter,
                                                      gradient,
                                                      args.learning_rate))
...
#    epoch_logger.subscribe_to('epoch time',
 #                             epoch_timer)
    ...
    '''
    trainer.epoch_callbacks += ([epoch_timer,
                                 LimitsNumEpochs(max_epochs)])
