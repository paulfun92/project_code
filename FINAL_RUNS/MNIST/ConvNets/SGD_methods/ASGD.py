...
from ASGD_extensions import SgdParameterUpdater, Sgd
...
def parse_args():
    ...
    parser.add_argument("--output-prefix",
                        ...
                        required=False,
			default='output',
                        help=("Directory and optional prefix of filename to save the log to."))
...
def main():
    ...
    epoch_logger = EpochLogger(output_prefix + "ASGD.h5")
