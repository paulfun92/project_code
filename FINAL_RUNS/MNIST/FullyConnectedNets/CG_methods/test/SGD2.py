...
from SGD_extensions import SgdParameterUpdater, Sgd
...
def parse_args():
    ...
    parser.add_argument("--batch-size",
                        ...
                        default=100,  # full batch method normally
                        help="batch size")
...
def main():
    ...
    parameter_updater = SgdParameterUpdater(params_flat,
                                            gradient,
                                            args.learning_rate)
    ...
    trainer = Sgd(inputs=[input_indices_symbolic],
                  input_iterator=mnist_training_iterator,
                  parameter_updater=parameter_updater,
                  callbacks=([#training_loss_monitor,
                             # training_misclassification_monitor,
                             parameter_updater,
                              validation_callback,
    ...
    print(params_flat.get_value().shape)
