...
training_tensors = [t[:-10000, ...] for t in tensors]
validation_tensors = [t[-10000:, ...] for t in tensors]
...
loss_node = CrossEntropy(softmax_layer, label_lookup_node)
...
model = SerializableModel([input_indices_symbolic], [softmax_layer])
...
misclassification_node = Misclassification(softmax_layer, label_lookup_node)
